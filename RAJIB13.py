...
def HOP_M1():
    ...
    def show_banner():
      ...
      {CYAN}   _______  _______  __   __  __   __  _______  __
                    ...
                    ╚═╝░░╚═╝╚═╝░░╚═╝░╚════╝░╚═╝╚═════╝░
        {YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
          [☬] {GREEN}DEVELOPER   :   MR-RAJIB-SORKAR-😈
          [☬] {GREEN}FACEBOOK    :    MR-RAJIB-SORKAR-😈
    ...
    def generate_data(num_entries, network_choice):
        ...
        for _ in range(num_entries):
            ...
            print(f"{GREEN}[RAJIB_💣]➤➤➤[O҉K҉🤍]:➤ {entry}{RAJIB}")  # Modified print statement
    ...
    def get_user_choice():
        ...
        if network_choice not in ["1", "2", "3", "4", "5", "6"]:
            print(f"{RED}Invalid choice, defaulting to ALL MIX (06).{RAJIB}")
            network_choice = "6"
        ...
        if choice == '1':
            ...
            print(f"{RED}Invalid choice, defaulting to 10 entries.{RAJIB}")
            num_entries = 10
    ...
    filename = 'RAJIB_ᗪᗩ丅ᗩ.txt'
    save_to_file(filename, data)

    print(f"{YELLOW}\nData saved to {filename}{RAJIB}")

    print(f"{RED}\ncode by S҉H҉I҉N҉C҉H҉O҉Y҉O҉N҉ ҉B҉A҉R҉U҉A҉ ҉A҉D҉I҉R҉T҉T҉A҉{RAJIB}")